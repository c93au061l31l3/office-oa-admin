<template>
    <div class="app-container">
      ...
      <el-table
        ...
        <el-table-column prop="name" label="菜單名稱" width="160"/>
        ...
        <el-table-column label="操作" width="180" align="center" fixed="right">
          <template slot-scope="scope">
            <el-button type="success" v-if="scope.row.type !== 2" icon="el-icon-plus" size="mini" @click="add(scope.row)" title="添加下级節點"/>
      ...
      <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="40%" >
        <el-form ref="dataForm" :model="sysMenu" label-width="150px" size="small" style="padding-right: 40px;">
          ...
          <el-form-item label="圖標" prop="icon" v-if="sysMenu.type !== 2">
          ...
          <el-form-item prop="path">
                <span slot="label">
                  <el-tooltip content="訪問的路由地址，如：`sysUser`" placement="top">
                  <i class="el-icon-question"></i>
                  </el-tooltip>
                  路由地址
                </span>
            <el-input v-model="sysMenu.path" placeholder="請輸入路由地址" />
          </el-form-item>
          ...
          <el-form-item v-if="sysMenu.type === 2">
            ...
            <span slot="label">
                  <el-tooltip content="控制器中定義的權限字符，如：@PreAuthorize(hasAuthority('bnt.sysRole.list'))" placement="top">
                  <i class="el-icon-question"></i>
                  </el-tooltip>
                  權限字符
                </span>
