    ...
    <div class="app-container">
      ...
      <div v-show="stepIndex == 1" style="margin-top: 20px;">
        <el-form ref="flashPromotionForm" label-width="150px" size="small" style="padding-right: 40px;">
          ...
          <el-form-item label="審批圖標">
            <el-select v-model="processTemplate.iconUrl" placeholder="請選擇審批圖標">
      ...
      <div v-show="stepIndex == 3" style="margin-top: 20px;">
        ...
        >
          ...
          <div class="el-upload__text">將Activiti流程設計文件拖到此處，或<em>點擊上傳</em></div>
          <div class="el-upload__tip" slot="tip">只能上傳zip壓縮文件，且不超過2048kb</div>
        </el-upload>
      </div>
    </div>
  </template>
  ...
  export default {
    ...
    methods: {
      ...
      beforeUpload(file) {
        ...
        if (!isLt2M) {
          this.$message.error('上傳文件大小不得超過 2MB!')
          return false
        }
        return true
      },
